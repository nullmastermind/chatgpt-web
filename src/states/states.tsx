...
export const useCurrentTool = createGlobalState<string | undefined | null>(localStorage.getItem(":currentTool"));
...
export const useAddCollectionAction = createGlobalState<() => void | undefined>();
